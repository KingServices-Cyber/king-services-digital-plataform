...
const FAQ_ITEMS = [
  {
    question: "O que é a KingServices e qual a relação com a Vivo Empresas?",
    answer:
      "A KingServices é uma parceira autorizada Vivo Empresas, especializada em soluções de telecomunicação e tecnologia para o mercado corporativo. Atuamos como consultores, ajudando empresas a escolher e implantar os serviços Vivo mais adequados ao seu perfil.",
  },
  {
  ...
  {
    question: "Qual o diferencial em contratar pela KingServices?",
    answer:
